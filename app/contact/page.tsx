        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <Card className="hover:shadow-lg transition-shadow bg-card border-border">
              ...
              <CardContent>
                <p className="text-lg font-semibold text-foreground">Freetown, Sierra Leone 🇸🇱</p>
                <p className="text-sm text-muted-foreground mt-2">
                  Mount Aureol, Freetown
                  <br />
                  Fourah Bay College Area
                  <br />
                  Sierra Leone
                </p>
                <a
          ...
          {/* Location - Full address & embedded map in app */}
          <div className="mb-12">
            ...
            <Card className="bg-card border-border overflow-hidden">
              <CardContent className="p-0">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="p-6">
                    <p className="text-lg font-semibold text-foreground mb-2">AI CV Builder</p>
                    ...
                    <div className="mt-4 space-y-2">
                      <a href="tel:+232073490048" className="block text-primary hover:underline">
                        +232 073 490 048
                      </a>
                      <a href="mailto:mb9274276@gmail.com" className="block text-primary hover:underline">
                        mb9274276@gmail.com
                      </a>
                    </div>
                    <a
                      href="https://maps.google.com/?q=8.4657,-13.2317"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <div className="aspect-video min-h-[250px] bg-muted">
                    <iframe
                      src="https://www.openstreetmap.org/export/embed.html?bbox=-13.35%2C8.40%2C-13.10%2C8.55&layer=mapnik&marker=8.4657%2C-13.2317"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
                      referrerPolicy="no-referrer-when-downgrade"
                      title="AI CV Builder Location - Freetown, Sierra Leone"
