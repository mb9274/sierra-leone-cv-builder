    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <main className="p-6 sm:p-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {[
            { title: "Jobs", desc: "Find matched jobs", icon: <Briefcase className="size-6" />, link: "/jobs", color: "bg-blue-50 text-blue-600" },
            { title: "Learning", desc: "Courses & Skills", icon: <BookOpen className="size-6" />, link: "/learning-center", color: "bg-green-50 text-green-600" },
            { title: "ATS Checker", desc: "Score your CV", icon: <FileSearch className="size-6" />, link: "/ats-checker", color: "bg-purple-50 text-purple-600" },
            { title: "Services", desc: "Citizen Support", icon: <Phone className="size-6" />, link: "/services", color: "bg-amber-50 text-amber-600" }
          ].map((feature) => (
            <Card
              key={feature.title}
