            ...
            {[
              {
                name: "Clare K.",
                location: "Freetown",
                img: "/happy-african-young-woman-professional.jpg",
                quote:
                  "Got my first job at Orange SL thanks to this CV builder! The AI suggestions made my experience sound so professional.",
              },
              {
                name: "Mohamed S.",
                location: "Bo",
                img: "/happy-african-young-man-professional-smile.jpg",
                quote: "Built my CV in 15 minutes and applied to 5 jobs the same day. Now I'm working at Rokel Bank!",
              },
              {
                name: "Fatima B.",
                location: "Makeni",
                img: "/happy-african-young-woman-celebrating-success.jpg",
                quote: "The templates made my CV look so professional. I got interview calls within a week!",
              },
            ].map((t) => (
      ...
      <footer className="border-t border-border bg-white py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li>
                  <a href="tel:+232073490048" className="hover:text-primary">
                    +232 073 490 048
                  </a>
                </li>
                <li>
                  <a href="mailto:mb9274276@gmail.com" className="hover:text-primary">
                    mb9274276@gmail.com
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-border pt-8 text-center">
            <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} AI CV Builder. Made for Sierra Leone</p>
          </div>
        </div>
      </footer>
    </div>
